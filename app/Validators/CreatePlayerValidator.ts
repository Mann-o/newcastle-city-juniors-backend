...
export default class CreatePlayerValidator {
  public schema = schema.create({
    ...
    alreadyProvidedVerification: schema.boolean(),
    identityVerificationPhoto: schema.file.nullableAndOptional(),
    ageVerificationPhoto: schema.file.nullableAndOptional(),
  ...
  public messages = {
    ...
    'alreadyProvidedVerification.required': `Field {{ field }} is required`,
    'alreadyProvidedVerification.boolean': `Field {{ field }} must be a boolean`,
