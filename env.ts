...
export default Env.rules({
  ...
  STRIPE_REG_FEE_SINGLE_TEAM_MALE: Env.schema.string(),
  STRIPE_REG_FEE_SINGLE_TEAM_FEMALE: Env.schema.string(),
  STRIPE_REG_FEE_DUAL_TEAM_MALE: Env.schema.string(),
  STRIPE_REG_FEE_DUAL_TEAM_FEMALE: Env.schema.string(),
  STRIPE_UPFRONT_SINGLE_TEAM_MALE: Env.schema.string(),
  STRIPE_UPFRONT_SINGLE_TEAM_FEMALE: Env.schema.string(),
  STRIPE_UPFRONT_DUAL_TEAM_MALE: Env.schema.string(),
  STRIPE_UPFRONT_DUAL_TEAM_FEMALE: Env.schema.string(),
  STRIPE_SUBS_SINGLE_TEAM_MALE: Env.schema.string(),
